...
- 2026-08-31 · Fernanda / ETHOS (Bia) · Task F1-T008 concluída: catálogo versionado, rastreabilidade, estados de revisão, regra contra aprovação sem código/fonte/versão, índice único, fixtures e tela `/catalogo`; QA 0.0.44 passou e teste humano aprovado.
...
- 2026-08-27 · ETHOS (Bia) · Task F1-T002 concluída: cadastro progressivo, Pessoa reaproveitável, Natureza/Classificação, origem/categoria, telefone e duplicidade; QA 0.0.33 passou e teste aprovado.
