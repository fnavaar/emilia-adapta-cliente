...
|---|---|---|---|---|---|---|---|---|
| F2-T001 | Aprovar tabela de preços, moeda e vigência | Gestão + Financeiro | 2-001 | B2-POL-01 tem fonte, versão, vigência e aprovador | Catálogo vigente | Sem tabela, não calcular total | aguardando validação humana | 1 |
