...
| F2-T002 | Aprovar frete, desconto, adicionais, validade, termos e alçadas | Gestão + Financeiro | 2-001 | B2-POL-02/03 definidos ou bloqueios explícitos | F2-T001 para cálculo | Não inventar fórmula | aguardando validação humana | 1 |
