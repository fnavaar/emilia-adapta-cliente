...
**Estado:** recertificação concluída. F3-T001, F3-T002 e F3-T003 concluídas; a base F1–F2 está recertificada e F3-T004 é a próxima elegível.
...
| F3-T004 | Configurar variantes e mínimos das quatro jornadas | Atendimento/Gestão | SPEC-3-002 | CA-3-009–014/031 | RED/GREEN das quatro fixtures | matriz, configuração e fixtures | F3-T003; parâmetros aprovados | Elegível | 4 |
| F3-T005 | Provar bordas e aceitar jornadas especiais | Champion | SPEC-3-002 | CA-3-009–014/031 | REGRESSÃO de tipo/data/urgência | roteiro, capturas e aceite | F3-T004 aceita | Bloqueada | 5 |
| F3-T006 | Construir fila, gates, RLS e instrução de produção | Responsável técnico | SPEC-3-003 | CA-3-015–020 | RED/GREEN de fila e alçada | migration, testes e capturas | F3-T005; G3-OPS-01 | Bloqueada | 6 |
| F3-T007 | Executar piloto híbrido e aceitar operação | Líder + Champion | SPEC-3-003 | CA-3-017–021 | REGRESSÃO e turno piloto | relatório, hashes e aceite | F3-T006 aceita | Bloqueada | 7 |
