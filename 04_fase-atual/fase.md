...
| F2-T003 | Fechar aceite, vencimento, conferência e estados | Gestão + Financeiro + Atendimento | 2-002 | B2-APR-01, B2-FIN-01 e B2-EST-01 têm transições/responsáveis | Gestão disponível | Não tratar resposta como aprovação | concluída documentalmente (aguarda teste humano) | 1 |
