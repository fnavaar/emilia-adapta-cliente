...
**Estado:** aberta com correção bloqueante. F3-T001 e F3-T002 concluídas; F3-T003 é a próxima elegível (regressão F2 e aceite humano da recertificação).

## Regra de execução

Uma task por vez. Teste humano obrigatório após cada task. As entregas funcionais F3-T004–T009 permanecem bloqueadas até F3-T003 recertificar a base. Nenhuma task publica produção.
