...
| F2-T004 | Definir retenção, formato e acesso de comprovantes | Gestão + Financeiro + Técnico | 2-002 | B2-FIN-02 especifica retenção, acesso e formatos | Usuários de homologação | Não receber arquivo real sem regra | concluída documentalmente (aguarda teste humano) | 1 |
